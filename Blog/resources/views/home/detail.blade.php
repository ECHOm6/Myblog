                     ...
                     <div class="blog-module shadow" style="box-shadow: 0 1px 8px #a6a6a6;">
                         <fieldset class="layui-elem-field layui-field-title" style="margin-bottom:0">
                             ...
                             <div class="layui-field-box">
                                 <form class="layui-form blog-editor" method="POST" action="{{route('comments')}}">
                                     ...
                                     <div class="layui-form-item">
                                         {{-- <button class="layui-btn" lay-submit lay-filter="sub">提交评论</button> --}}
                                        <input type="submit" class="layui-btn" lay-submit lay-filter="sub" value="提交评论" >
                                     </div>
                                 </form>
                             </div>
                         </fieldset>
                         ...
                         <ul class="blog-comment">
                             ...
                             <li>
                             <div class="comment-parent"> 
                                 @foreach($com->cuser as $res)
                                <img src="{{$res->avatar}}" alt="absolutely" />
                                <div class="info">
                                   
                                    <span class="username">{{$res->name}}</span>
                                    <span class="time">2017-03-18 18:46:06</span>
                             ...
                             <script>
                                 var arr=[];
                                 for(var i=0;i<$('.blog-comment>li').length;i++){
                               arr.push( $('.blog-comment>li').eq(i).html());
                                 }
                                arr.reverse()
                             for(var j=0;j<$('.blog-comment>li').length;j++){
                                $('.blog-comment>li').eq(j).html(arr[j]);
                             }
                             </script>
                         </ul>
                     </div>
