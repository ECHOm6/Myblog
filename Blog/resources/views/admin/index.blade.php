...
<div class="container">
    <div class="logo">
        <a href="./index.html">Dpl-admin v2.2</a></div>
    <div class="left_open">
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="博客用户管理">&#xe6b8;</i>
                    <cite>博客用户管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('统计页面','{{url("admin/welcome")}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>统计页面</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('用户列表','{{url("admin/menber-list")}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>用户列表</cite></a>
                    </li>
                  {{--  <li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('文章列表','{{url("admin/articlelist")}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>文章列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('文章分类','order-list1.html')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>文章分类</cite></a>
                    </li>
                </ul>
          ...
          {{--  <li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('管理员列表','{{url("admin/admin-list")}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理员列表</cite></a>
                    </li>
                    <li>
                        <a onclick="xadmin.add_tab('角色管理','{{url("admin/admin-role")}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>角色管理</cite></a>
                    </li>
                    {{--<li>
                        <a onclick="xadmin.add_tab('权限分类','{{url("admin/admin-cate")}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限分类</cite></a>
                    </li>--}}
                    <li>
                        <a onclick="xadmin.add_tab('权限管理','{{url("admin/admin-rule")}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限管理</cite></a>
                    </li>
                </ul>
